...
// Preload every model type so they're cached before mounting
...
function Streetlight({ x, z }: { x: number; z: number }) {
  return (
    <group position={[x, 0, z]}>
      ...
      <mesh position={[0.7, 5.0, 0]}>
        <cylinderGeometry args={[0.03, 0.03, 1.4, 5]} rotation={[0, 0, Math.PI / 2]} />
        <meshStandardMaterial color="#2a2a2a" metalness={0.9} roughness={0.2} />
      </mesh>
